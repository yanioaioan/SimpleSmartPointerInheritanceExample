#############################################################################
# Makefile for building: SimpleSmartPointerInheritanceExample
# Generated by qmake (3.0) (Qt 5.5.0)
# Project:  SimpleSmartPointerInheritanceExample.pro
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -o Makefile SimpleSmartPointerInheritanceExample.pro
#############################################################################
...
CXXFLAGS      = -pipe -O2 -std=c++1y -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -I. -I/opt/qt/5.5/gcc_64/include -I/opt/qt/5.5/gcc_64/include/QtGui -I/opt/qt/5.5/gcc_64/include/QtCore -I. -I/opt/qt/5.5/gcc_64/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = SimpleSmartPointerInheritanceExample1.0.0
DISTDIR = /home/yioannidis/QtStuff/Projects/SimpleSmartPointerInheritanceExample/.tmp/SimpleSmartPointerInheritanceExample1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/opt/qt/5.5/gcc_64 -Wl,-rpath,/opt/qt/5.5/gcc_64/lib
LIBS          = $(SUBLIBS) -L/opt/qt/5.5/gcc_64/lib -lQt5Gui -L/usr/lib64 -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
OBJECTS       = main.o
DIST          = ../../../.qmake.stash \
		SimpleSmartPointerInheritanceExample.pro  main.cpp
QMAKE_TARGET  = SimpleSmartPointerInheritanceExample
...
Makefile: SimpleSmartPointerInheritanceExample.pro ../../../.qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-g++/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		/opt/qt/5.5/gcc_64/mkspecs/features/c++14.prf \
		...
		SimpleSmartPointerInheritanceExample.pro \
		/opt/qt/5.5/gcc_64/lib/libQt5Gui.prl \
		/opt/qt/5.5/gcc_64/lib/libQt5Core.prl
	$(QMAKE) -o Makefile SimpleSmartPointerInheritanceExample.pro
